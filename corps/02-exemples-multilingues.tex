...
\noindent Rendu (avec du vrai texte) :
...
\begin{latexcode}
... plusieurs écritures.\footnote{Arabe \ar{ ... }, russe \ru{ ... }.}
\end{latexcode}

\noindent Rendu : une note peut contenir plusieurs
...
\begin{latexcode}
D'après \textcite{barhudarov1975}, la traduction ...
... la traductologie outillée \autocite{schlechtweg-etal-2020-semeval}.
\end{latexcode}

\noindent Rendu : les références à titre non latin s'affichent et se
trient correctement grâce à \code{biber} — voir par exemple
\textcite{barhudarov1975} (russe), \textcite{xietianzhen1999} (chinois) et
