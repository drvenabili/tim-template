...
% Tigrinya : polyglossia ne fournit pas de « gloss » tigrinya (seul
% l'amharique existe pour l'éthiopien), d'où des avertissements inutiles.
% L'écriture éthiopique (guèze) est de gauche à droite et n'a pas besoin
% de bidi : on se contente d'appliquer la police \tigrinyafont (définie
% dans polices.tex). On ne déclare donc PAS \setotherlanguage{tigrinya}.
% ---------------------------------------------------------------------
